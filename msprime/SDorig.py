...
T = [55940,51395,47457,43984,40877,38067,35501,33141,30956,28922,27018,25231,23545,21951,20439,19000,17628,16318,15063,13859,12702,11590,10517,9482,8483,7516,6580,5672,5520,5156,4817,4500,4203,3922,3656,3404,3165,2936,2718,2509,2308,2116,1930,1752,1579,1413,1252,1096,945,798,656,517,383,252,124]

eur_schiffels_durbin_initial = [
    msprime.PopulationConfiguration(sample_size=1,initial_size=613285)]

eur_schiffels_durbin_orig = [
...
dd = msprime.DemographyDebugger(
	demographic_events=eur_schiffels_durbin_orig, 
