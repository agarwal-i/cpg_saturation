...
plink --freq --real-ref-alleles --bed raw/ukb23155_c${chr}_b0_v1.bed --bim raw/UKBexomeOQFE_chr${chr}.bim --fam raw/ukb23155_c${chr}_b0_v1_s200621.fam --out int/chr$chr
wait
